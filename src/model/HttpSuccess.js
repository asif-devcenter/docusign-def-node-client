...
class HttpSuccess {
    ...
    /**
     * Validates the JSON data with respect to <code>HttpSuccess</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HttpSuccess</code>.
     */
 ...
 */
HttpSuccess.prototype['status'] = undefined;
